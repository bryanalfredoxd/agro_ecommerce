...
CREATE TABLE `productos` (
  ...
  `costo_promedio_usd` decimal(15,2) DEFAULT 0.00,
  `precio_venta_usd` decimal(15,2) NOT NULL,
  `precio_oferta_usd` decimal(15,2) DEFAULT NULL,
  `unidad_medida` enum('unidad','kg','g','mg','litro','ml','galon','saco','bulto','paquete','caja','tambor','paila','frasco','metro','rollo','dosis','blister') DEFAULT 'unidad',
  `contenido_neto` decimal(10,3) DEFAULT NULL,
  `unidad_contenido` enum('kg','g','mg','l','ml','cc','galon','oz','m','cm','dosis','unidad') DEFAULT 'kg',
  ...
  `stock_total` decimal(12,0) DEFAULT 0.000,
  `stock_minimo_alerta` decimal(12,0) DEFAULT 5.000,
