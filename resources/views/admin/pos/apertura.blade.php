    ...
    <main class="flex-1 min-w-0 flex flex-col h-screen justify-center items-center p-4">
        ...
        <div class="w-full max-w-md bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden animate-fade-in-up">
            ...
            <form action="{{ route('admin.pos.abrirCaja') }}" method="POST" class="p-6 sm:p-8 space-y-6">
                ...
                <div>
                    <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2 ml-1">Selecciona tu Caja</label>
                ...
                <div>
                    <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2 ml-1">Efectivo Base (USD)</label>
                    <div class="relative">
                    ...
                    <p class="text-[10px] text-gray-400 font-bold mt-2 ml-1">El monto con el que recibes la caja para dar vueltos.</p>
                </div>
